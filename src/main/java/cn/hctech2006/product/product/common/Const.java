...
public class Const {
    ...
    public enum TBTYPE{
        GOODSNAME("商品名称","name"),
        GOODSSHORTS("商品简称","shorts"),
        CUSTOMERNAME("客户名称","name"),
        CUSTOMERSHORTS("客户简称","shorts"),
        PROVIDERNAME("供应商名称","name"),
        PROVIDERSHORTS("供应商简称","shorts");

        TBTYPE(String name, String vaue) {
            this.name = name;
            this.vaue = vaue;
        }
