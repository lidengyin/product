...
public class OutputTV {

    private SimpleStringProperty goodsName;

    private SimpleStringProperty outputId;
    ...
    public OutputTV(String goodsName, String outputId
        ...
        this.outputId = new SimpleStringProperty(outputId);
    ...
    public SimpleStringProperty outputIdProperty() {
        return outputId;
    }

    public void setOutputId(String outputId) {
        this.outputId.set(outputId);
    }
